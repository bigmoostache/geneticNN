...
class model_01(torch.nn.Module):
	def __init__(self, 
		...
		self.model_Linear_1 = Linear.Linear(___input_dim____ = ___input_dim_Linear_1____, ___dtype____ = ___dtype_Linear_1____, ___output_dim____ = ___input_dim_Linear_2____, ___bias____ = ___bias_Linear_1____, ___device____ = ___device_Linear_1____, )
		# Initializing model Linear_2
		self.model_Linear_2 = Linear.Linear(___input_dim____ = ___input_dim_Linear_2____, ___dtype____ = ___dtype_Linear_1____, ___output_dim____ = ___input_dim_Linear_3____, ___bias____ = ___bias_Linear_2____, ___device____ = ___device_Linear_1____, )
		# Initializing model Linear_3
		self.model_Linear_3 = Linear.Linear(___input_dim____ = ___input_dim_Linear_3____, ___dtype____ = ___dtype_Linear_1____, ___output_dim____ = ___input_dim_ReLU3____, ___bias____ = ___bias_Linear_3____, ___device____ = ___device_Linear_1____, )
